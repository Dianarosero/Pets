...
<body>
    ...
    <center>
        ...
        <form name="editUserFrom" action="http://127.0.0.1/pets/back/src/update.php" method="POST">
            ...
            <label>Ident.name</label>&nbsp<input type="text" name="id_num" value='<?php echo $ident;?>' required disable="true"><br><br>
            ...
            <label>Password</label>&nbsp<input type="password" name="passwd"  value='<?php echo $contra;?>' required  disable="true"><br><br>
